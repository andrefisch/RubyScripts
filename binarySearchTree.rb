...
class BinarySearchTree
    ...
    # mark s
    def search(value)
        puts "Searching for: " + value.to_s
        current_node = @root
        while nil != current_node && current_node.value != value
            if (value < current_node.value) && (current_node.left != nil)
                puts value.to_s + " is less than " + current_node.value.to_s + " checking its left child"
                current_node = current_node.left
            elsif (value > current_node.value) && (current_node.right != nil)
                puts value.to_s + " is greater than " + current_node.value.to_s + " checking its right child"
        ...
        if current_node != nil
            puts "Value found: " + current_node.value.to_s
        else 
